...
function OnGUI()
{
  GUI.Label(new Rect(0,0,100,100),(Input.acceleration.x.ToString()));
   GUI.Label(new Rect(0,100,100,100),(Input.acceleration.y.ToString()));
    GUI.Label(new Rect(0,200,100,100),(Input.acceleration.z.ToString()));
